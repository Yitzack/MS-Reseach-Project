...
/*{0.35, 2.4, 2.9, 2.5, 0.1, 5.5, 9.07, 1, 3, 1, 1.51, 3.09, 2.4, 5.5, 0.0923598, 0.953503, 0.92782, 0.794774, 0.532935, 0.363389, 0.335334, 0.0987568} T=320 MeV Grid*/
...
int main(int argc, char* argv[])
{
	long double JPsi_Parameters[5][5][3] = {{{.314831,.314831,1.},{3.0969,3.0969,1},{.032,.032,1},{9.34,9.34,1},{1,1,1}},
						...
						{{.266834,.44,3.3},{3.1855,3.15,1.5},{.98,.056,5.},{9.52,9.52,1.},{3,1,1}}};
