...
SpatialConstInter["24.1"]=Table[
\[Omega]Tab=Join[Range[0,7,.25],{Select[Range[\[Pi]/(2z),1/z 2 32\[Pi]+\[Pi]/(2z),\[Pi]/z],#<=32&][[-1]]-15,23.5}];(*How to devide up the space-like mesons*)
Print[{Now,z}];(*check progress*)
{z,
...
ParallelTable[{\[Omega]Tab[[Mod[i,30]+1]],\[Omega]Tab[[Mod[i,30]+1]]+Floor[i/30],NIntegrate[Kernel["General Neg"][\[Omega],z,P]\[Sigma]TotalConst[\[Omega]^2-P^2,P,"24.1"],{\[Omega],\[Omega]Tab[[Mod[i,30]+1]],\[Omega]Tab[[Mod[i,30]+2]]},{P,Min[\[Omega]+Floor[i/30],Select[Range[\[Pi]/(2z),(2 32\[Pi])/z+\[Pi]/(2z),\[Pi]/z],#<=32&][[-1]]],Min[\[Omega]+Floor[i/30]+1,Select[Range[\[Pi]/(2z),(2 32\[Pi])/z+\[Pi]/(2z),\[Pi]/z],#<=32&][[-1]]]},Method->"GaussKronrodRule"]},{i,0,30 15-1}],(*space-like contributions*)
ParallelTable[{Select[Range[\[Pi]/(2z),(2 32\[Pi])/z+\[Pi]/(2z),\[Pi]/z],#<=32&][[-1]]-15+i,Select[Range[\[Pi]/(2z),(2 32\[Pi])/z+\[Pi]/(2z),\[Pi]/z],#<=32&][[-1]],NIntegrate[2\[Omega] Kernel["Cutoff"][\[Omega]^2-Select[Range[\[Pi]/(2z),(2 32\[Pi])/z+\[Pi]/(2z),\[Pi]/z],#<=32&][[-1]]^2,z,Select[Range[\[Pi]/(2z),(2 32\[Pi])/z+\[Pi]/(2z),\[Pi]/z],#<=32&][[-1]]]\[Sigma]TotalConst[\[Omega]^2-Select[Range[\[Pi]/(2z),(2 32\[Pi])/z+\[Pi]/(2z),\[Pi]/z],#<=32&][[-1]]^2,Select[Range[\[Pi]/(2z),(2 32\[Pi])/z+\[Pi]/(2z),\[Pi]/z],#<=32&][[-1]],"24.1"],{\[Omega],Select[Range[\[Pi]/(2z),(2 32\[Pi])/z+\[Pi]/(2z),\[Pi]/z],#<=32&][[-1]]-15+i,Select[Range[\[Pi]/(2z),(2 32\[Pi])/z+\[Pi]/(2z),\[Pi]/z],#<=32&][[-1]]-14+i},Method->"GaussKronrodRule"]},{i,0,14}],(*space-like cutoff contributions*)
...
SpatialTotalInter["24.1"]=Table[\[Omega]Tab=Join[Range[0,7,.25],{Select[Range[\[Pi]/(2z),1/z 2 32\[Pi]+\[Pi]/(2z),\[Pi]/z],#<=32&][[-1]]-15,23.5}];Print[{Now,z}];{z,ParallelTable[{sTab[[Mod[i,29]+1]],Select[Range[\[Pi]/(2z),(2 32\[Pi])/z+\[Pi]/(2z),\[Pi]/z],#<=32&][[Floor[i/29]+1]],NIntegrate[Kernel["General"][s,z,P]{\[Sigma]TotalInter[s,P,"24.1"],\[Sigma]TotalInter[s,0,"24.1"]},{s,sTab[[Mod[i,29]+1]],sTab[[Mod[i,29]+2]]},{P,Join[{0},Select[Range[\[Pi]/(2z),(2 32\[Pi])/z+\[Pi]/(2z),\[Pi]/z],#<=32&]][[Floor[i/29]+1]],Select[Range[\[Pi]/(2z),(2 32\[Pi])/z+\[Pi]/(2z),\[Pi]/z],#<=32&][[Floor[i/29]+1]]},Method->"GaussKronrodRule"]},{i,0,29(Dimensions[Select[Range[\[Pi]/(2z),(2 32\[Pi])/z+\[Pi]/(2z),\[Pi]/z],#<=32&]][[1]])-1}],ParallelTable[{sTab[[Mod[i,29]+1]],Select[Range[\[Pi]/(2z),(2 32\[Pi])/z+\[Pi]/(2z),\[Pi]/z],#<=32&][[Floor[i/29]+1]],NIntegrate[Kernel["Cutoff"][s,z,Select[Range[\[Pi]/(2z),(2 32\[Pi])/z+\[Pi]/(2z),\[Pi]/z],#<=32&][[Floor[i/29]+1]]]{\[Sigma]TotalInter[s,Select[Range[\[Pi]/(2z),(2 32\[Pi])/z+\[Pi]/(2z),\[Pi]/z],#<=32&][[Floor[i/29]+1]],"24.1"],\[Sigma]TotalInter[s,0,"24.1"]},{s,sTab[[Mod[i,29]+1]],sTab[[Mod[i,29]+2]]},Method->"GaussKronrodRule"]},{i,0,29(Dimensions[Select[Range[\[Pi]/(2z),(2 32\[Pi])/z+\[Pi]/(2z),\[Pi]/z],#<=32&]][[1]])-1}],ParallelTable[{\[Omega]Tab[[Mod[i,30]+1]],\[Omega]Tab[[Mod[i,30]+1]]+Floor[i/30],NIntegrate[Kernel["General Neg"][\[Omega],z,P]\[Sigma]TotalInter[\[Omega]^2-P^2,P,"24.1"],{\[Omega],\[Omega]Tab[[Mod[i,30]+1]],\[Omega]Tab[[Mod[i,30]+2]]},{P,Min[\[Omega]+Floor[i/30],Select[Range[\[Pi]/(2z),(2 32\[Pi])/z+\[Pi]/(2z),\[Pi]/z],#<=32&][[-1]]],Min[\[Omega]+Floor[i/30]+1,Select[Range[\[Pi]/(2z),(2 32\[Pi])/z+\[Pi]/(2z),\[Pi]/z],#<=32&][[-1]]]},Method->"GaussKronrodRule"]},{i,0,30 15-1}],ParallelTable[{Select[Range[\[Pi]/(2z),(2 32\[Pi])/z+\[Pi]/(2z),\[Pi]/z],#<=32&][[-1]]-15+i,Select[Range[\[Pi]/(2z),(2 32\[Pi])/z+\[Pi]/(2z),\[Pi]/z],#<=32&][[-1]],NIntegrate[2\[Omega] Kernel["Cutoff"][\[Omega]^2-Select[Range[\[Pi]/(2z),(2 32\[Pi])/z+\[Pi]/(2z),\[Pi]/z],#<=32&][[-1]]^2,z,Select[Range[\[Pi]/(2z),(2 32\[Pi])/z+\[Pi]/(2z),\[Pi]/z],#<=32&][[-1]]]\[Sigma]TotalInter[\[Omega]^2-Select[Range[\[Pi]/(2z),(2 32\[Pi])/z+\[Pi]/(2z),\[Pi]/z],#<=32&][[-1]]^2,Select[Range[\[Pi]/(2z),(2 32\[Pi])/z+\[Pi]/(2z),\[Pi]/z],#<=32&][[-1]],"24.1"],{\[Omega],Select[Range[\[Pi]/(2z),(2 32\[Pi])/z+\[Pi]/(2z),\[Pi]/z],#<=32&][[-1]]-15+i,Select[Range[\[Pi]/(2z),(2 32\[Pi])/z+\[Pi]/(2z),\[Pi]/z],#<=32&][[-1]]-14+i},Method->"GaussKronrodRule"]},{i,0,14}],ParallelTable[{sTab[[i]],NIntegrate[Kernel["Lorentz"][s,z]\[Sigma]TotalInter[s,0,"24.1"],{s,sTab[[i]],sTab[[i+1]]},Method->"GaussKronrodRule"]},{i,29}]},{z,.25,6.25,.25}];
...
SpatialNon["24.1"]=Table[\[Omega]Tab=Join[Range[0,7,.25],{Select[Range[\[Pi]/(2z),1/z 2 32\[Pi]+\[Pi]/(2z),\[Pi]/z],#<=32&][[-1]]-15,23.5}];Print[{Now,z}];{z,ParallelTable[{sTab[[Mod[i,29]+1]],Select[Range[\[Pi]/(2z),(2 32\[Pi])/z+\[Pi]/(2z),\[Pi]/z],#<=32&][[Floor[i/29]+1]],NIntegrate[Kernel["General"][s,z,P]{\[Sigma]Non[s,P,"24.1"],\[Sigma]Non[s,0,"24.1"]},{s,sTab[[Mod[i,29]+1]],sTab[[Mod[i,29]+2]]},{P,Join[{0},Select[Range[\[Pi]/(2z),(2 32\[Pi])/z+\[Pi]/(2z),\[Pi]/z],#<=32&]][[Floor[i/29]+1]],Select[Range[\[Pi]/(2z),(2 32\[Pi])/z+\[Pi]/(2z),\[Pi]/z],#<=32&][[Floor[i/29]+1]]},Method->"GaussKronrodRule"]},{i,0,29(Dimensions[Select[Range[\[Pi]/(2z),(2 32\[Pi])/z+\[Pi]/(2z),\[Pi]/z],#<=32&]][[1]])-1}],ParallelTable[{sTab[[Mod[i,29]+1]],Select[Range[\[Pi]/(2z),(2 32\[Pi])/z+\[Pi]/(2z),\[Pi]/z],#<=32&][[Floor[i/29]+1]],NIntegrate[Kernel["Cutoff"][s,z,Select[Range[\[Pi]/(2z),(2 32\[Pi])/z+\[Pi]/(2z),\[Pi]/z],#<=32&][[Floor[i/29]+1]]]{\[Sigma]Non[s,Select[Range[\[Pi]/(2z),(2 32\[Pi])/z+\[Pi]/(2z),\[Pi]/z],#<=32&][[Floor[i/29]+1]],"24.1"],\[Sigma]Non[s,0,"24.1"]},{s,sTab[[Mod[i,29]+1]],sTab[[Mod[i,29]+2]]},Method->"GaussKronrodRule"]},{i,0,29(Dimensions[Select[Range[\[Pi]/(2z),(2 32\[Pi])/z+\[Pi]/(2z),\[Pi]/z],#<=32&]][[1]])-1}],ParallelTable[{\[Omega]Tab[[Mod[i,30]+1]],\[Omega]Tab[[Mod[i,30]+1]]+Floor[i/30],NIntegrate[Kernel["General Neg"][\[Omega],z,P]\[Sigma]Non[\[Omega]^2-P^2,P,"24.1"],{\[Omega],\[Omega]Tab[[Mod[i,30]+1]],\[Omega]Tab[[Mod[i,30]+2]]},{P,Min[\[Omega]+Floor[i/30],Select[Range[\[Pi]/(2z),(2 32\[Pi])/z+\[Pi]/(2z),\[Pi]/z],#<=32&][[-1]]],Min[\[Omega]+Floor[i/30]+1,Select[Range[\[Pi]/(2z),(2 32\[Pi])/z+\[Pi]/(2z),\[Pi]/z],#<=32&][[-1]]]},Method->"GaussKronrodRule"]},{i,0,30 15-1}],ParallelTable[{Select[Range[\[Pi]/(2z),(2 32\[Pi])/z+\[Pi]/(2z),\[Pi]/z],#<=32&][[-1]]-15+i,Select[Range[\[Pi]/(2z),(2 32\[Pi])/z+\[Pi]/(2z),\[Pi]/z],#<=32&][[-1]],NIntegrate[2\[Omega] Kernel["Cutoff"][\[Omega]^2-Select[Range[\[Pi]/(2z),(2 32\[Pi])/z+\[Pi]/(2z),\[Pi]/z],#<=32&][[-1]]^2,z,Select[Range[\[Pi]/(2z),(2 32\[Pi])/z+\[Pi]/(2z),\[Pi]/z],#<=32&][[-1]]]\[Sigma]Non[\[Omega]^2-Select[Range[\[Pi]/(2z),(2 32\[Pi])/z+\[Pi]/(2z),\[Pi]/z],#<=32&][[-1]]^2,Select[Range[\[Pi]/(2z),(2 32\[Pi])/z+\[Pi]/(2z),\[Pi]/z],#<=32&][[-1]],"24.1"],{\[Omega],Select[Range[\[Pi]/(2z),(2 32\[Pi])/z+\[Pi]/(2z),\[Pi]/z],#<=32&][[-1]]-15+i,Select[Range[\[Pi]/(2z),(2 32\[Pi])/z+\[Pi]/(2z),\[Pi]/z],#<=32&][[-1]]-14+i},Method->"GaussKronrodRule"]},{i,0,14}],ParallelTable[{sTab[[i]],NIntegrate[Kernel["Lorentz"][s,z]\[Sigma]Non[s,0,"24.1"],{s,sTab[[i]],sTab[[i+1]]},Method->"GaussKronrodRule"]},{i,29}]},{z,.25,6.25,.25}];
