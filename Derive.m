...
Sub1 = N[Transpose[{Master[[2,All,1]],Master[[2,All,2,2]]}],6];(*Extract the subtables*)
Sub2 = N[Transpose[{Master[[2,All,1]],Master[[2,All,2,3]]}],6];
e1 = Sub1[[;;465,1,2]]; (*Pull the choice of s from the table*)

ImGV1 = Interpolation[Sub1, Method -> "Spline", InterpolationOrder -> 2];
ImGV2 = Interpolation[Sub2, Method -> "Spline", InterpolationOrder -> 2];
