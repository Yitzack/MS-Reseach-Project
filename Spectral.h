...
void Characterize_Folding(long double[5], int, long double, long double, long double[10], long double[10], int&);	//Returns the poles of the folding integral's integrands
