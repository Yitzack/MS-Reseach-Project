	...
	else
	{
		...
		else if(sqrt(Par[4]+pow(Par[3],2)) > Energy(Par[2], Par[3]/2., k, theta) || sqrt(Par[4]+pow(Par[3],2)) > Energy(Par[2], Par[3]/2., -k, theta))
		{
			if(sqrt(Par[4]+pow(Par[3],2)) > Energy(Par[2], Par[3]/2., -k, theta))
				...
				long double holder2 = Rho(Energy(Par[2], Par[3]/2., k, theta)-Energy(Par[2], Par[3]/2., -k, theta),Par, LawCosines(Par[3]/2.,k,theta), theta, Temp)*(1.-Fermi(Energy(Par[2], Par[3]/2., k, theta)-Energy(Par[2], Par[3]/2., -k, theta), Temp)-Fermi(Energy(Par[2], Par[3]/2., k, theta), Temp))/Energy(Par[2], Par[3]/2., -k, theta);
				return(holder1/holder2*Rho(sqrt(Par[4]+pow(Par[3],2))-Energy(Par[2], Par[3]/2., -k, theta),Par, LawCosines(Par[3]/2.,k,theta), theta, Temp)*(1.-Fermi(sqrt(Par[4]+pow(Par[3],2))-Energy(Par[2], Par[3]/2., -k, theta), Temp)-Fermi(Energy(Par[2], Par[3]/2., k, theta), Temp))/Energy(Par[2], Par[3]/2., -k, theta));
			}
			else
			{
