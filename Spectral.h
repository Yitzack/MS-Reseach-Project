...
long double Analytic(long double E, long double Epsilon)	//Vacuum doesn't need self-energy E dependance, epsilon is .008GeV for the natural width.
...
{
	return(arctan(E));	//Trying arctan({1,2,4}E/GeV}) and exp(-{.2,.1,.05}GeV/E)
}
