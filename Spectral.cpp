...
int main(int argc, char* argv[])
{
...
#endif
#ifdef CC
     	char File[30] = "SpectralccNormal.";  //Name of the file
#endif
#ifdef RIEK
	...
	long double Par[5] = {-14408.581911213045*M_PI, 7.40806621324779, 1.8, 0, 0};
	Elements holder;
	...
	for(i = atoi(argv[6]); i <= Finish; i++)	//Argv[6] allows to restart where ever
	{
