...
/*#ifndef BB	//use option -D BB= to activate BB macro
	...
	long double Par[5] = {-14408.581911213045, 7.40806621324779, 1.8, 0, 0};
	Elements holder;
	...
	for(long double omega = 3.95; omega <= 4.55; omega += .00001)
		cout << omega << " " << Spin_Sum1(Par, omega, 4.19821, 0)*ImFolding_Integrand1(Par,omega,4.19821,0,1) << endl;*/
